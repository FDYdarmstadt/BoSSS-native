...
extern "C" {
    ...
    MYLIBRARY_API QuadScheme call_quad_multi_poly_withDataTwoLS(PhiData a, PhiData b, int pA, int pB, int q, quadType type);
    MYLIBRARY_API QuadSchemeCombo call_quad_multi_poly_withDataCombo(PhiData a, int p, int q, quadType type);
    MYLIBRARY_API QuadSchemeCombo call_quad_multi_poly_withDataComboTwoLS(PhiData a, PhiData b, int pA, int pB, int q, quadType type);
